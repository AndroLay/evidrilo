...
This file records third-party materials that are bundled or otherwise require
an easily discoverable notice in the public source package. The project license
itself remains the single root [`LICENSE`](LICENSE) file.

## Source Sans 3

The bundled Source Sans 3 font files are distributed under the SIL Open Font
License 1.1. The applicable notice is reproduced here so the public repository
does not need additional license files in nested directories.

Copyright 2010-2022 Adobe (http://www.adobe.com/), with Reserved Font Name
'Source'. All Rights Reserved. Source is a trademark of Adobe in the United
States and/or other countries.

This Font Software is licensed under the SIL Open Font License, Version 1.1.

This license is also available from <http://scripts.sil.org/OFL>.
...
2. Original or Modified Versions of the Font Software may be bundled,
   ...
   as stand-alone text files, human-readable headers, or in appropriate
...
3. No Modified Version of the Font Software may use the Reserved Font Name(s)
   ...
   Copyright Holder. This restriction applies only to the primary font name as
   presented to the users.
4. The name(s) of the Copyright Holder(s) or the Author(s) of the Font Software
   shall not be used to promote, endorse or advertise any Modified Version,
   except to acknowledge the contribution of the Copyright Holder(s) and the
...
INDIRECT, INCIDENTAL, OR CONSEQUENTIAL DAMAGES, ARISING FROM, OUT OF THE USE
OR INABILITY TO USE THE FONT SOFTWARE OR FROM OTHER DEALINGS IN THE FONT
SOFTWARE.

## Evidrilo audio effects
...
The exact source descriptors, SHA-256 checksums, and this notice reference are
...
duration, byte length, checksum, and review owner/date in the internal review
workflow. Run the strict asset validator after every manifest change.
