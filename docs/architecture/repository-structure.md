...
E191 adds the target mobile surface host and the bounded published-case
catalogue without introducing a duplicate domain source of truth or changing
the source-first module boundaries.
