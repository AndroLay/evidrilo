...
internal data class EvidriloFreeLearningPolicy(
    val caseCount: Int,
 ...
 */
internal val EVIDRILO_FREE_LEARNING_POLICY = EvidriloFreeLearningPolicy(
    caseCount = 1,
...
internal data class EvidriloOnboardingPresentation(
...
internal fun evidriloOnboardingPresentation(
    completed: Boolean,
