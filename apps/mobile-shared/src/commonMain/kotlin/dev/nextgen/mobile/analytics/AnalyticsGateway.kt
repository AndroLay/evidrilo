...
internal data class AnalyticsClientConfiguration(
...
internal enum class AnalyticsDeferralReason {
    NOT_CONFIGURED,
    AUTH_REQUIRED,
    SESSION_EXPIRED,
    SECURE_STORAGE,
...
internal sealed interface AnalyticsGatewayResult {
...
internal class AnalyticsGateway(
...
internal fun createPlatformAnalyticsGateway(): AnalyticsGateway {
