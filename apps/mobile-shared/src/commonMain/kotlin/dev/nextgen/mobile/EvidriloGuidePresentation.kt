...
internal enum class EvidriloGuideTopic {
    SUPPORTING_EVIDENCE,
    CLAIM_BOUNDS,
    FEEDBACK_REVISION,
}

internal data class EvidriloGuideTopicCopy(
    val title: String,
    val subtitle: String,
    val body: String,
)

internal val evidriloGuideTopics: List<EvidriloGuideTopic> = listOf(
    EvidriloGuideTopic.SUPPORTING_EVIDENCE,
    EvidriloGuideTopic.CLAIM_BOUNDS,
    EvidriloGuideTopic.FEEDBACK_REVISION,
)

internal fun guideTopicCopy(topic: EvidriloGuideTopic): EvidriloGuideTopicCopy = when (topic) {
