...
internal enum class AccountPresentationAction {
    NONE,
    SIGN_OUT,
}
...
internal fun AccountSession.toPresentation(): AccountPresentation = when (this) {
...
internal fun AccountSession.toSettingsSubtitle(): String = when (this) {
