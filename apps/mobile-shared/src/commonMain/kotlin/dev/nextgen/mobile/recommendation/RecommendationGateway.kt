...
internal sealed interface RecommendationGatewayResult {
...
internal data class RecommendationClientConfiguration(
...
internal enum class RecommendationDeferralReason {
    CONSENT_REQUIRED,
    AUTH_REQUIRED,
    SESSION_EXPIRED,
    SECURE_STORAGE,
...
internal sealed interface RecommendationInteractionResult {
...
internal class RecommendationGateway(
...
internal fun createPlatformRecommendationGateway(): RecommendationGateway {
