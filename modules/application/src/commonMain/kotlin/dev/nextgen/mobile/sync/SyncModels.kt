...
const val MAX_SYNC_COMMANDS: Int = 50
const val MAX_SYNC_CURSOR: Long = 1_000_000_000_000_000L
...
fun SyncCommandIntent.validate(): SyncValidationResult {
...
fun isValidSyncUuid(value: String): Boolean = uuidPattern.matches(value)

fun isValidSyncCaseVersion(value: String): Boolean = caseVersionPattern.matches(value)

fun isValidSyncDigest(value: String): Boolean = digestPattern.matches(value)

fun isValidSyncRequestId(value: String): Boolean =
