...
fun practiceStartedAnalyticsEvent(
    attemptId: String,
...
fun paywallViewedAnalyticsEvent(surfaceId: String): AnalyticsEvent = AnalyticsEvent(
    clientEventId = newAnalyticsEventId(),
...
fun premiumActionAnalyticsEvent(
    action: String,
...
fun attemptCompletedAnalyticsEvent(
    attemptId: String,
    caseVersionId: String,
...
fun revisionRecordedAnalyticsEvent(
    attemptId: String,
    caseVersionId: String,
...
fun recommendationShownAnalyticsEvent(
    caseVersionId: String,
    skillId: String?,
...
fun recommendationAcceptedAnalyticsEvent(
    caseVersionId: String,
    skillId: String?,
): AnalyticsEvent = recommendationAnalyticsEvent(
...
fun recommendationDismissedAnalyticsEvent(
    caseVersionId: String,
    skillId: String?,
): AnalyticsEvent = recommendationAnalyticsEvent(
