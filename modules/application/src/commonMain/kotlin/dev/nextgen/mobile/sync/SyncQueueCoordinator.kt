...
sealed interface SyncQueueFlushResult {
...
sealed interface SyncQueuePullResult {
...
data class SyncQueueSyncResult(
    val pull: SyncQueuePullResult,
    val flush: SyncQueueFlushResult,
)

data class SyncConsentClearOutcome(
    val pendingCount: Int,
    val message: String,
)

fun syncConsentClearOutcome(
