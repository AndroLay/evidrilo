...
public sealed class CohortEndpointTests : IClassFixture<ApiFactory>
{
    private static readonly Guid UserId = Guid.Parse("123e4567-e89b-42d3-a456-426614174000");
    private static readonly Guid CohortId = Guid.Parse("123e4567-e89b-42d3-a456-426614174010");
    private readonly HttpClient client;

    public CohortEndpointTests(ApiFactory factory)
    {
    ...
    [Fact]
    public async Task Cohort_summary_requires_verified_identity()
    {
    ...
    [Fact]
    public async Task Cohort_summary_fails_closed_when_database_is_not_configured()
    {
        using var request = new HttpRequestMessage(
            HttpMethod.Get,
            $"/v1/teacher/cohorts/{CohortId}/summary");
