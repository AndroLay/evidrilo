...
public sealed class EntitlementEndpointTests : IClassFixture<ApiFactory>
{
    private static readonly Guid UserId = Guid.Parse("123e4567-e89b-42d3-a456-426614174000");
    private readonly HttpClient client;

    public EntitlementEndpointTests(ApiFactory factory)
    {
    ...
    [Fact]
    public async Task Entitlements_require_verified_identity()
    {
    ...
    [Fact]
    public async Task Entitlements_fail_closed_when_database_is_not_configured()
    {
        using var request = new HttpRequestMessage(HttpMethod.Get, "/v1/billing/entitlements");
