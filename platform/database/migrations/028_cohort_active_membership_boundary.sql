-- Evidrilo P7, keep cohort aggregates aligned with active organization membership.
-- An enrollment is not sufficient to keep a learner in an organization cohort:
-- revocation/leave may happen before a separate enrollment cleanup operation.
